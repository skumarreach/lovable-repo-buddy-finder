        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white rounded-lg shadow-lg p-6 text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">{t('social.twitter.title')}</h3>
              <p className="text-gray-600 mb-4">{t('social.twitter.description')}</p>
              <button className="bg-blue-600 text-white px-6 py-2 rounded-full hover:bg-blue-700 transition-colors">
                {t('social.twitter.button')}
              </button>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">{t('social.facebook.title')}</h3>
              <p className="text-gray-600 mb-4">{t('social.facebook.description')}</p>
              <button className="bg-indigo-600 text-white px-6 py-2 rounded-full hover:bg-indigo-700 transition-colors">
                {t('social.facebook.button')}
              </button>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">{t('social.pinterest.title')}</h3>
              <p className="text-gray-600 mb-4">{t('social.pinterest.description')}</p>
              <button className="bg-pink-600 text-white px-6 py-2 rounded-full hover:bg-pink-700 transition-colors">
                {t('social.pinterest.button')}
              </button>
            </div>
          </div>
        </div>
