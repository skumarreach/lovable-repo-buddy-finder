        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Connect with our community, share your experiences, and stay updated with the latest news and events from Gurukulam.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white rounded-lg shadow-lg p-6 text-center">
              ...
              <p className="text-gray-600 mb-4">Stay updated with our latest news and initiatives</p>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Join Our Facebook</h3>
              <p className="text-gray-600 mb-4">Connect with fellow supporters and share your stories</p>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Pinterest Board</h3>
              <p className="text-gray-600 mb-4">Explore our visual stories and inspiration</p>
