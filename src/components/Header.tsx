      ...
      <div className="container mx-auto px-5 flex flex-col md:flex-row justify-between items-center">
        ...
        <nav className="mt-4 md:mt-0">
          <ul className="flex space-x-6">
            ...
            <li><Link to="/causes" className="hover:text-slate-300 transition-colors">Causes</Link></li>
            <li><Link to="/gallery" className="hover:text-slate-300 transition-colors">Gallery</Link></li>
            <li><Link to="/donate" className="hover:text-slate-300 transition-colors">Donate</Link></li>
